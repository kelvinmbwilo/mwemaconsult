...
--
-- Host: localhost
-- Generation Time: Nov 24, 2014 at 07:16 AM
...
CREATE TABLE IF NOT EXISTS `academic_qualification` (
  ...
  `establish_name` varchar(255) NOT NULL,
  `referencemethod` varchar(255) NOT NULL,
  `dateproduced` date NOT NULL,
  `imageattached` varchar(5) NOT NULL,
  `candidate_adate` date NOT NULL,
  `reference_adate` date NOT NULL,
  `candidate_course` varchar(255) NOT NULL,
  `reference_course` varchar(255) NOT NULL,
  `candidate_grade` varchar(255) NOT NULL,
  `reference_grade` varchar(255) NOT NULL,
...
--
-- Table structure for table `adverse_namesmatched`
--

CREATE TABLE IF NOT EXISTS `adverse_namesmatched` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `namematchedon` varchar(255) NOT NULL,
  `age` varchar(20) NOT NULL,
  `Extract` int(11) NOT NULL,
  `adverseid` int(11) NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `updated_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;
...
--
-- Table structure for table `adversemediacheck`
--

CREATE TABLE IF NOT EXISTS `adversemediacheck` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `searchteam` varchar(255) NOT NULL,
  `datesearch` date NOT NULL,
  `totalmatches` varchar(255) NOT NULL,
  `matchesonly` varchar(255) NOT NULL,
...
(1, 'Statiol', '565361', '2', 'info@statiol.com', '0712636361', '4565361', '2014-11-22 02:54:09', '2014-11-23 15:27:41');
...
--
-- Table structure for table `criminalcheck`
--

CREATE TABLE IF NOT EXISTS `criminalcheck` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `comments` varchar(255) NOT NULL,
  `employee_id` int(11) NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
--
-- Table structure for table `cvanalysis`
--
...
--
-- Table structure for table `emphistory_dates`
--

CREATE TABLE IF NOT EXISTS `emphistory_dates` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `candidate_sdate` date NOT NULL,
  `referee_sdate` date NOT NULL,
  `candidate_edate` date NOT NULL,
  `referee_edate` date NOT NULL,
  `emphistory_id` int(11) NOT NULL,
...
--
-- Table structure for table `emphistory_jobs`
--

CREATE TABLE IF NOT EXISTS `emphistory_jobs` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `oganisation` varchar(255) NOT NULL,
...
--
-- Table structure for table `emphistory_references`
--

CREATE TABLE IF NOT EXISTS `emphistory_references` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `employee` (`id`, `company_id`, `firstname`, `middlename`, `lastname`, `dob`, `gender`, `address`, `created_at`, `updated_at`) VALUES
(1, 1, 'sdfsfd', 'hjhj', 'jhjhjhj', 'jhjhj', 'Male', 'jjhjhjk', '2014-11-22 17:55:08', '2014-11-22 17:55:08'),
(7, 1, 'fsdfaffdafdasfdsaf', 'dsfsgsdgfdsgfds', 'gfsdgfdsgfdsgfds', 'gfsfsgfsgfsg', 'Female', 'sgfsdgfdsvfdsgfdsgf', '2014-11-23 00:21:18', '2014-11-23 00:21:18'),
(8, 1, 'bfdsssssgsdg', 'fdghdg', 'dhghdgf', 'dhhhdgfdh', 'Female', 'gdhgd', '2014-11-23 00:25:03', '2014-11-23 00:25:03'),
(13, 1, 'fdgfdsg', 'vhhh', 'hvhvhvhvh', '2010-03-30', 'Male', 'fgfdsghdghdgfd', '2014-11-23 01:41:11', '2014-11-23 01:41:11'),
(14, 1, 'gbchfdh', 'fhgdhgfd', 'ghdgfdhgdfhgd', '1990-09-04', 'Female', 'gsfsdgfds', '2014-11-23 02:29:08', '2014-11-23 02:29:08'),
(15, 1, 'kelvin', 'kulwa', 'mbwilo', '1990-02-20', 'Male', 'box 46 dar es saalam', '2014-11-23 05:48:51', '2014-11-23 05:48:51'),
(16, 1, 'yrey', 'yry', 'teyrey', 'yy', 'Male', 'uytuyr', '2014-11-23 11:55:15', '2014-11-23 11:55:15'),
(17, 1, 'hgjhg', 'mnbvnv', 'mvbvn', 'vmnn', 'Male', 'nvnnb', '2014-11-23 12:42:18', '2014-11-23 12:42:18'),
(18, 1, 'ghdfh', 'dhg', 'hdgdhgg', 'hdgdh', 'Female', 'hdhdhfd', '2014-11-23 12:44:21', '2014-11-23 12:44:21'),
(19, 1, 'fdgfsdgd', 'fghd', 'gdsfgfsdg', 'hhf', 'Male', 'hfdgdsfg', '2014-11-23 12:46:08', '2014-11-23 12:46:08');
...
--
-- Table structure for table `gapanalysis_history`
--

CREATE TABLE IF NOT EXISTS `gapanalysis_history` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `period` int(10) NOT NULL,
  `comments` varchar(255) NOT NULL,
  `gapanalysis_id` int(11) NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `updated_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;
...
--
-- Table structure for table `iddocumentcheck`
--

CREATE TABLE IF NOT EXISTS `iddocumentcheck` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `validated` varchar(5) NOT NULL,
  `rating` varchar(5) NOT NULL,
  `alias` varchar(5) NOT NULL,
  `mortality` varchar(5) NOT NULL,
  `currentaddress` varchar(5) NOT NULL,
  `datapiece` varchar(5) NOT NULL,
  `screen_id` int(11) NOT NULL,
  `id_score` int(11) NOT NULL,
  `address_score` int(11) NOT NULL,
...
--
-- Dumping data for table `iddocumentcheck`
--

INSERT INTO `iddocumentcheck` (`id`, `validated`, `rating`, `alias`, `mortality`, `currentaddress`, `datapiece`, `screen_id`, `id_score`, `address_score`, `description`, `created_at`, `updated_at`) VALUES
(1, 'rqrew', 'Low', 'No', 'No', 'Yes', 'rqrew', 63, 2, 1, 'dfkkla fas fkksda fkd jskf dksfk dkasfkdsjfkd akfdsjfkd skfdas jfkd skf jdsakfkdskf ks fkds jfkdsafjklfkdskfdskhfihasif adfia', '2014-11-24 02:03:36', '2014-11-23 22:23:59');
...
(39, 8, 'Logging in', '2014-11-22 17:04:45', '2014-11-22 17:04:45'),
(40, 8, 'Logging in', '2014-11-22 23:24:02', '2014-11-22 23:24:02'),
(41, 8, 'Create a new order for fdgfdsg hvhvhvhvh', '2014-11-23 01:41:24', '2014-11-23 01:41:24'),
(42, 8, 'Create a new order for gbchfdh ghdgfdhgdfhgd', '2014-11-23 02:29:16', '2014-11-23 02:29:16'),
(43, 8, 'Logging in', '2014-11-23 05:41:40', '2014-11-23 05:41:40'),
(44, 8, 'Create a new order for kelvin mbwilo', '2014-11-23 05:49:12', '2014-11-23 05:49:12'),
(45, 8, 'Logging in', '2014-11-23 09:33:55', '2014-11-23 09:33:55'),
(46, 8, 'Logging in', '2014-11-23 09:38:51', '2014-11-23 09:38:51'),
(47, 8, 'Logging in', '2014-11-23 09:39:20', '2014-11-23 09:39:20'),
(48, 8, 'Logging in', '2014-11-23 09:43:10', '2014-11-23 09:43:10'),
(49, 1, 'Logging in', '2014-11-23 10:37:56', '2014-11-23 10:37:56'),
(50, 8, 'Logging in', '2014-11-23 10:42:41', '2014-11-23 10:42:41'),
(51, 8, 'Logging in', '2014-11-23 11:43:04', '2014-11-23 11:43:04'),
(52, 8, 'Create a new order for yrey teyrey', '2014-11-23 11:55:23', '2014-11-23 11:55:23'),
(53, 8, 'Create a new order for ghdfh hdgdhgg', '2014-11-23 12:44:31', '2014-11-23 12:44:31'),
(54, 8, 'Create a new order for fdgfsdgd gdsfgfsdg', '2014-11-23 12:46:17', '2014-11-23 12:46:17'),
(55, 8, 'Logging in', '2014-11-23 15:24:56', '2014-11-23 15:24:56'),
(56, 1, 'Logging in', '2014-11-23 15:25:16', '2014-11-23 15:25:16'),
(57, 1, 'Update Company named Statiol', '2014-11-23 15:27:41', '2014-11-23 15:27:41'),
(58, 8, 'Logging in', '2014-11-23 15:38:30', '2014-11-23 15:38:30'),
(59, 1, 'Logging in', '2014-11-23 15:48:46', '2014-11-23 15:48:46'),
(60, 1, 'Logging in', '2014-11-23 21:24:58', '2014-11-23 21:24:58'),
(61, 8, 'Logging in', '2014-11-23 22:28:34', '2014-11-23 22:28:34'),
(62, 1, 'Logging in', '2014-11-23 22:44:33', '2014-11-23 22:44:33'),
(63, 8, 'Logging in', '2014-11-24 00:23:52', '2014-11-24 00:23:52');
...
('2014_11_23_132010_create_password_reminders_table', 2);
...
INSERT INTO `order` (`id`, `company_id`, `employee_id`, `result_id`, `status`, `file`, `completed_date`, `created_at`, `updated_at`) VALUES
(13, 1, 13, 0, 'pending', '3DHoverEffects.zip', '', '2014-11-23 01:41:11', '2014-11-23 01:41:11'),
(14, 1, 14, 0, 'pending', 'main pics.zip', '', '2014-11-23 02:29:08', '2014-11-23 02:29:08'),
(15, 1, 15, 0, 'In Progress', 'mwemaconsult.sql', '', '2014-11-23 05:48:52', '2014-11-23 17:12:21'),
(16, 1, 16, 0, 'pending', 'fpdf17.zip', '', '2014-11-23 11:55:15', '2014-11-23 11:55:16'),
(17, 1, 17, 0, 'Declined', '', '', '2014-11-23 12:42:18', '2014-11-23 17:06:51'),
(18, 1, 18, 0, 'pending', 'fpdf17.zip', '', '2014-11-23 12:44:21', '2014-11-23 12:44:21'),
(19, 1, 19, 0, 'pending', 'fpdf17.zip', '', '2014-11-23 12:46:08', '2014-11-23 12:46:08');
...
CREATE TABLE IF NOT EXISTS `orderScreening` (
  ...
  `visibilty_status` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `updated_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  PRIMARY KEY (`id`)
...
--
-- Dumping data for table `orderScreening`
--

INSERT INTO `orderScreening` (`id`, `order_id`, `employee_id`, `screen_id`, `complete`, `visibilty_status`, `created_at`, `updated_at`) VALUES
(53, 13, 13, 1, 20, '', '2014-11-23 05:36:46', '2014-11-23 01:41:11'),
(54, 13, 13, 5, 45, '', '2014-11-23 05:36:50', '2014-11-23 01:41:11'),
(55, 13, 13, 6, 37, '', '2014-11-23 05:36:53', '2014-11-23 01:41:11'),
(56, 13, 13, 7, 70, '', '2014-11-23 05:36:57', '2014-11-23 01:41:11'),
(57, 14, 14, 1, 80, '', '2014-11-23 05:36:59', '2014-11-23 02:29:08'),
(58, 14, 14, 2, 30, '', '2014-11-23 05:37:04', '2014-11-23 02:29:08'),
(59, 14, 14, 3, 54, '', '2014-11-23 05:37:08', '2014-11-23 02:29:08'),
(60, 14, 14, 4, 67, '', '2014-11-23 05:37:11', '2014-11-23 02:29:08'),
(61, 14, 14, 5, 90, '', '2014-11-23 05:37:15', '2014-11-23 02:29:08'),
(62, 14, 14, 6, 79, '', '2014-11-23 05:37:27', '2014-11-23 02:29:08'),
(63, 15, 15, 1, 100, 'hidden', '2014-11-24 01:23:59', '2014-11-23 22:23:59'),
(64, 15, 15, 2, 0, '', '2014-11-23 05:48:52', '2014-11-23 05:48:52'),
(65, 15, 15, 3, 0, '', '2014-11-23 05:48:52', '2014-11-23 05:48:52'),
(66, 15, 15, 4, 0, '', '2014-11-23 05:48:52', '2014-11-23 05:48:52'),
(67, 15, 15, 5, 0, '', '2014-11-23 05:48:52', '2014-11-23 05:48:52'),
(68, 15, 15, 6, 0, '', '2014-11-23 05:48:52', '2014-11-23 05:48:52'),
(69, 16, 16, 1, 0, '', '2014-11-23 11:55:15', '2014-11-23 11:55:15'),
(70, 16, 16, 2, 0, '', '2014-11-23 11:55:15', '2014-11-23 11:55:15'),
(71, 16, 16, 3, 0, '', '2014-11-23 11:55:15', '2014-11-23 11:55:15'),
(72, 16, 16, 4, 0, '', '2014-11-23 11:55:15', '2014-11-23 11:55:15'),
(73, 16, 16, 5, 0, '', '2014-11-23 11:55:15', '2014-11-23 11:55:15'),
(74, 16, 16, 6, 0, '', '2014-11-23 11:55:16', '2014-11-23 11:55:16'),
(75, 16, 16, 7, 0, '', '2014-11-23 11:55:16', '2014-11-23 11:55:16'),
(76, 16, 16, 8, 0, '', '2014-11-23 11:55:16', '2014-11-23 11:55:16'),
(77, 16, 16, 9, 0, '', '2014-11-23 11:55:16', '2014-11-23 11:55:16'),
(78, 18, 18, 0, 0, '', '2014-11-23 12:44:21', '2014-11-23 12:44:21'),
(79, 18, 18, 0, 0, '', '2014-11-23 12:44:21', '2014-11-23 12:44:21'),
(80, 18, 18, 0, 0, '', '2014-11-23 12:44:21', '2014-11-23 12:44:21'),
(81, 18, 18, 0, 0, '', '2014-11-23 12:44:21', '2014-11-23 12:44:21'),
(82, 18, 18, 0, 0, '', '2014-11-23 12:44:21', '2014-11-23 12:44:21'),
(83, 18, 18, 0, 0, '', '2014-11-23 12:44:21', '2014-11-23 12:44:21'),
(84, 19, 19, 1, 0, '', '2014-11-23 12:46:08', '2014-11-23 12:46:08'),
(85, 19, 19, 2, 0, '', '2014-11-23 12:46:08', '2014-11-23 12:46:08'),
(86, 19, 19, 3, 0, '', '2014-11-23 12:46:08', '2014-11-23 12:46:08'),
(87, 19, 19, 4, 0, '', '2014-11-23 12:46:08', '2014-11-23 12:46:08'),
(88, 19, 19, 5, 0, '', '2014-11-23 12:46:08', '2014-11-23 12:46:08'),
(89, 19, 19, 6, 0, '', '2014-11-23 12:46:08', '2014-11-23 12:46:08');
...
(5, 1, 'Professional Qualifications', 'Confirmation of professional qualifications/trade memberships,\r\nincluding levels and dates of affiliation.', '', '2014-11-22 09:09:46', '2014-11-22 09:09:46'),
...
(1, 'kelvin', 'mbwilo', 'admin', 'kelvinmbwilo@gmail.com', '$2y$10$ZCyvphrdKm.oKQXo.uYTK.9dSB.VHkmLuaWiFtT6M6Ba339fX9Dni', '0717524556', 'admin', 0, '33tzZvNjgdNBcaYw6oU3xUzcoPMPs2n2sGuY4O1aO7JrC3Wp9s5vw2AOdaCv', '2014-11-22 02:45:26', '2014-11-24 00:23:48'),
...
(8, 'cadsda', 'daada', 'c', 'dsafsa@fsdgf.gsfd', '$2y$10$f..3loEO6Wd9UqZJOfw5Qum/uc0kIJNZ6IRZt8S9vsCnezAklDcFm', 'fdsafsadf', 'company', 1, 'MhqGIUmSsSkdprx5Iws7axow5ccTlZgdhu3aXiYyGunls5RIwHNTRmVj8qUI', '2014-11-22 05:58:57', '2014-11-24 01:15:32');
