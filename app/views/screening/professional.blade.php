 ...
 <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td>
        ...
        <div class="row">
           <div class="col-sm-12"> 
             <h3 class="text-info">Professional qualifications</h3>
           </div>
        </div>
              ...
              <div class="form-group">
                 <div class="col-sm-12">
                   <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table table-bordered">
                     ...
                     <tr>
                       <td align="left" valign="top"><strong>Attendence Date</strong></td>
                     ...
                     <tr>
                       <td align="left" valign="top"><strong>Name of qualification</strong></td>
