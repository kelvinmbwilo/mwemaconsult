<form name="validity" method="post" 
action="{{ url('form/submit/professionvalidity/'.$screen->id) }}" id="FileUploader">
 <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td>
        ...
        <div class="row">
           <div class="col-sm-12"> 
             <h3 class="text-info">Profesional Qualification for {{ $screen->employee->firstname }} {{ $screen->employee->lastname }} from {{ $screen->employee->company->name }}</h3>
           </div>
        </div>
        <div class="row">
           <div class="col-sm-12"> 
