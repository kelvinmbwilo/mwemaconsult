...
<div class="col-sm-12" style="padding: 10px; background-color: #F3F3F3;height: 100px;font-size: 1.2em">
    ...
    <table class="table table-bordered table-striped summarytable">
        ...
        @foreach($screen->academic->historyreference as $est)
        <tr>
...
<div class="row">
    <div class="col-sm-12">
      @foreach($screen->academic->qualification as $qf)
    <table class="table table-bordered table-striped summarytable">
        <tr>
            <th width="302">Qualification</th>
            <th width="337" colspan="2">{{$screen->academic->establishment->establish_name}}</th>
      </tr>
        <tr>
